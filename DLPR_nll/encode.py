...
if __name__ == '__main__':
    ...
    parser.add_argument('-tau', type=int, default=0, help='Quantization step size adjustment parameter')
    ...
    code_lossy, code_res, img_shape, res_range = compress(nll_module, I, COT, tau=args.tau)
    ...
    with open(args.output, 'wb') as f:
        pickle.dump((code_lossy, code_res, img_shape, res_range,args.tau), f)
